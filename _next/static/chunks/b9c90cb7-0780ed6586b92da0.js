...
`,oC=Z.button`
  ...
  ${e=>e.$active?F.iv`
        ...
        `}
`,om={scale:[.9,1.25,1.6],opacity:[0,.11,0]},of={ease:"linear",duration:2,repeat:1/0},ov=Z.div`
  position: absolute;
  left: 50%;
  top: 50%;
...
`,oD=Z(M.E.span)``,oT=Z(M.E.div)``,oR={desktop:{ConnectorButton:F.iv`
  ...
  &:after {
    ...
    animation: ${oB} 2s linear infinite;
  }
`,oH=Z.div`
  transition: opacity 300ms ease;
  min-width: fit-content;
...
`,Tooltip=({children:e,message:o,open:t,xOffset:n=0,yOffset:i=0,delay:r})=>{var a;let s=useContext(),l=useThemeContext();if(null===(a=s.options)||void 0===a?void 0:a.hideTooltips)return(0,j.jsx)(j.Fragment,{children:e});let[c,d]=(0,L.useState)(!1),[p,h]=(0,L.useState)(!1),[u,x]=(0,L.useState)("small"),[b,g]=(0,L.useState)(!1),[C]=(0,L.useState)(s.route),m=(0,L.useRef)(null),[f,v]=(0,W.Z)({debounce:b?0:220,offsetSize:!0,scroll:!0}),checkBounds=()=>{let e=!1,o=n+v.left+v.width,t=i+v.top+.5*v.height;return(o>window.innerWidth||o<0||t>window.innerHeight||t<0)&&(e=!0),e},k="undefined"!=typeof window?L.useLayoutEffect:L.useEffect;return k(()=>{if(!m.current||v.top+v.bottom+v.left+v.right+v.height+v.width===0)return;let e=n+v.left+v.width,o=i+v.top+.5*v.height;b||0===e||0===o||g(!0),m.current.style.left=`${e}px`,m.current.style.top=`${o}px`,x(m.current.offsetHeight<=40?"small":"large"),h(checkBounds())},[v,t,c]),(0,L.useEffect)(()=>{s.open||d(!1)},[s.open]),(0,L.useEffect)(()=>{d(!!t)},[t]),(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(M.E.div,{ref:f,style:void 0===t?{cursor:"help"}:{},onHoverStart:()=>d(!0),onHoverEnd:()=>d(!1),onClick:()=>d(!1),children:e}),(0,j.jsx)(Portal,{children:(0,j.jsx)(S.M,{children:C===s.route&&!p&&c&&(0,j.jsx)(J,{$useTheme:l.theme,$useMode:l.mode,$customTheme:l.customTheme,children:(0,j.jsx)(tt,{children:(0,j.jsxs)(tn,{role:"tooltip",$size:u,ref:m,initial:"collapsed",animate:b?"open":{},exit:"collapsed",variants:{collapsed:{transformOrigin:"20px 50%",opacity:0,scale:.9,z:.01,y:"-50%",x:20,transition:{duration:.1}},open:{willChange:"opacity,transform",opacity:1,scale:1,z:.01,y:"-50%",x:20,transition:{ease:[.76,0,.24,1],duration:.15,delay:r||.5}}},children:[o,(0,j.jsx)(ti,{$size:u})]})})})})})]})},tr=Z(M.E.div)`
  z-index: 4;
  position: relative;
  overflow: hidden;
  svg {
...
`,CircleSpinner=({logo:e,smallLogo:o,connecting:t=!0,unavailable:n=!1,countdown:i=!1})=>(0,j.jsxs)(tb,{transition:{duration:.5,ease:[.175,.885,.32,.98]},children:[(0,j.jsx)(tg,{$small:!n&&o,style:n?{borderRadius:0}:void 0,children:e}),(0,j.jsx)(tC,{children:(0,j.jsxs)(S.M,{children:[t&&(0,j.jsx)(tf,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0,transition:{duration:i?1:0}},children:(0,j.jsxs)("svg",{"aria-hidden":"true",width:"102",height:"102",viewBox:"0 0 102 102",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,j.jsx)("path",{d:"M52 100C24.3858 100 2 77.6142 2 50",stroke:"url(#paint0_linear_1943_4139)",strokeWidth:"3.5",strokeLinecap:"round",strokeLinejoin:"round"}),(0,j.jsx)("defs",{children:(0,j.jsxs)("linearGradient",{id:"paint0_linear_1943_4139",x1:"2",y1:"48.5",x2:"53",y2:"100",gradientUnits:"userSpaceOnUse",children:[(0,j.jsx)("stop",{stopColor:"var(--ck-spinner-color)"}),(0,j.jsx)("stop",{offset:"1",stopColor:"var(--ck-spinner-color)",stopOpacity:"0"})]})})]})},"Spinner"),i&&(0,j.jsxs)(tm,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.25},children:[(0,j.jsx)("div",{}),(0,j.jsx)("div",{})]},"ExpiringSpinner")]})})]}),tv={CONNECTED:"connected",CONNECTING:"connecting",EXPIRING:"expiring",FAILED:"failed",REJECTED:"rejected",NOTCONNECTED:"notconnected",UNAVAILABLE:"unavailable"},tk={initial:{willChange:"transform,opacity",position:"relative",opacity:0,scale:.95},animate:{position:"relative",opacity:1,scale:1,transition:{ease:[.16,1,.3,1],duration:.4,delay:.05,position:{delay:0}}},exit:{position:"absolute",opacity:0,scale:.95,transition:{ease:[.16,1,.3,1],duration:.3}}},ConnectWithInjector=({switchConnectMethod:e,forceState:o})=>{var t,n,i,r,a,s,l,c,d,p,h,u;let x;let{connect:b}=useConnect({onMutate:e=>{e.connector?N(tv.CONNECTING):N(tv.UNAVAILABLE)},onError(e){console.error(e)},onSettled(e,o){if(o){if(y(!0),setTimeout(()=>y(!1),3500),o.code)switch(o.code){case -32002:N(tv.NOTCONNECTED);break;case 4001:N(tv.REJECTED);break;default:N(tv.FAILED)}else o.message&&("User rejected request"===o.message?N(tv.REJECTED):N(tv.FAILED))}setTimeout(g,100)}}),{triggerResize:g,connector:C}=useContext(),m=C.id,f=useWallet(m,C.name),v=useInjectedWallet(),k=isInjectedConnector(null==f?void 0:f.id)&&v.enabled?{name:v.wallet.name,shortName:null!==(t=v.wallet.shortName)&&void 0!==t?t:v.wallet.name,icon:v.wallet.icon,iconShape:null!==(i=null===(n=v.wallet)||void 0===n?void 0:n.iconShape)&&void 0!==i?i:"circle",iconShouldShrink:null!==(r=v.wallet.iconShouldShrink)&&void 0!==r&&r}:{name:null==f?void 0:f.name,shortName:null!==(a=null==f?void 0:f.shortName)&&void 0!==a?a:null==f?void 0:f.name,icon:null!==(s=null==f?void 0:f.iconConnector)&&void 0!==s?s:null==f?void 0:f.icon,iconShape:null!==(l=null==f?void 0:f.iconShape)&&void 0!==l?l:"circle",iconShouldShrink:null==f?void 0:f.iconShouldShrink},[w,y]=(0,L.useState)(!1);(0,L.useState)(9);let E=detectBrowser(),M=null===(c=null==f?void 0:f.downloadUrls)||void 0===c?void 0:c[E],I=(null==f?void 0:f.downloadUrls)?{name:Object.keys(null==f?void 0:f.downloadUrls)[0],label:(null===(d=Object.keys(null==f?void 0:f.downloadUrls)[0])||void 0===d?void 0:d.charAt(0).toUpperCase())+(null===(p=Object.keys(null==f?void 0:f.downloadUrls)[0])||void 0===p?void 0:p.slice(1)),url:null==f?void 0:f.downloadUrls[Object.keys(null==f?void 0:f.downloadUrls)[0]]}:void 0,[F,N]=(0,L.useState)(o||((null==f?void 0:f.isInstalled)?tv.CONNECTING:tv.UNAVAILABLE)),A=useLocales({CONNECTORNAME:k.name,CONNECTORSHORTNAME:null!==(h=k.shortName)&&void 0!==h?h:k.name,SUGGESTEDEXTENSIONBROWSER:null!==(u=null==I?void 0:I.label)&&void 0!==u?u:"your browser"}),runConnect=async()=>{(null==f?void 0:f.isInstalled)&&(null==f?void 0:f.connector)?b({connector:null==f?void 0:f.connector}):N(tv.UNAVAILABLE)};return((0,L.useEffect)(()=>{if(F!==tv.UNAVAILABLE)return x=setTimeout(runConnect,600),()=>{clearTimeout(x)}},[]),f)?isWalletConnectConnector(null==f?void 0:f.connector.id)?(0,j.jsx)(er,{children:(0,j.jsxs)(o8,{children:[(0,j.jsx)(es,{children:"Invalid State"}),(0,j.jsx)(ec,{children:(0,j.jsx)(Alert,{children:"WalletConnect does not have an injection flow. This state should never happen."})})]})}):(0,j.jsx)(er,{children:(0,j.jsxs)(o8,{children:[(0,j.jsx)(o6,{children:(0,j.jsxs)(o7,{$shake:F===tv.FAILED||F===tv.REJECTED,$circle:"circle"===k.iconShape,children:[(0,j.jsx)(S.M,{children:(F===tv.FAILED||F===tv.REJECTED)&&(0,j.jsx)(te,{"aria-label":"Retry",initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.8},whileTap:{scale:.9},transition:{duration:.1},onClick:runConnect,children:(0,j.jsx)(to,{children:(0,j.jsx)(Tooltip,{open:w&&(F===tv.FAILED||F===tv.REJECTED),message:A.tryAgainQuestion,xOffset:-6,children:(0,j.jsx)(RetryIconCircle,{})})})})}),"circle"===k.iconShape?(0,j.jsx)(CircleSpinner,{logo:F===tv.UNAVAILABLE?(0,j.jsx)("div",{style:{transform:"scale(1.14)",position:"relative",width:"100%"},children:k.icon}):(0,j.jsx)(j.Fragment,{children:k.icon}),smallLogo:k.iconShouldShrink,connecting:F===tv.CONNECTING,unavailable:F===tv.UNAVAILABLE}):(0,j.jsx)(SquircleSpinner,{logo:F===tv.UNAVAILABLE?(0,j.jsx)("div",{style:{transform:"scale(1.14)",position:"relative",width:"100%"},children:k.icon}):(0,j.jsx)(j.Fragment,{children:k.icon}),connecting:F===tv.CONNECTING})]})}),(0,j.jsx)(el,{children:(0,j.jsxs)(S.M,{initial:!1,children:[F===tv.FAILED&&(0,j.jsxs)(o5,{initial:"initial",animate:"animate",exit:"exit",variants:tk,children:[(0,j.jsxs)(ec,{children:[(0,j.jsxs)(ed,{$error:!0,children:[(0,j.jsx)(AlertIcon,{}),A.injectionScreen_failed_h1]}),(0,j.jsx)(ep,{children:A.injectionScreen_failed_p})]}),(null==f?void 0:f.createUri)&&"coinbaseWallet"!==f.id&&(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(OrDivider,{}),(0,j.jsx)(Button,{icon:(0,j.jsx)(Scan,{}),onClick:()=>e(m),children:A.scanTheQRCode})]})]},tv.FAILED),F===tv.REJECTED&&(0,j.jsxs)(o5,{initial:"initial",animate:"animate",exit:"exit",variants:tk,children:[(0,j.jsxs)(ec,{style:{paddingBottom:28},children:[(0,j.jsx)(ed,{children:A.injectionScreen_rejected_h1}),(0,j.jsx)(ep,{children:A.injectionScreen_rejected_p})]}),(null==f?void 0:f.createUri)&&"coinbaseWallet"!==f.id&&(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(OrDivider,{}),(0,j.jsx)(Button,{icon:(0,j.jsx)(Scan,{}),onClick:()=>e(m),children:A.scanTheQRCode})]})]},tv.REJECTED),(F===tv.CONNECTING||F===tv.EXPIRING)&&(0,j.jsx)(o5,{initial:"initial",animate:"animate",exit:"exit",variants:tk,children:(0,j.jsxs)(ec,{style:{paddingBottom:28},children:[(0,j.jsx)(ed,{children:"injected"===f.connector.id?A.injectionScreen_connecting_injected_h1:A.injectionScreen_connecting_h1}),(0,j.jsx)(ep,{children:"injected"===f.connector.id?A.injectionScreen_connecting_injected_p:A.injectionScreen_connecting_p})]})},tv.CONNECTING),F===tv.CONNECTED&&(0,j.jsx)(o5,{initial:"initial",animate:"animate",exit:"exit",variants:tk,children:(0,j.jsxs)(ec,{children:[(0,j.jsxs)(ed,{$valid:!0,children:[(0,j.jsx)(TickIcon,{})," ",A.injectionScreen_connected_h1]}),(0,j.jsx)(ep,{children:A.injectionScreen_connected_p})]})},tv.CONNECTED),F===tv.NOTCONNECTED&&(0,j.jsx)(o5,{initial:"initial",animate:"animate",exit:"exit",variants:tk,children:(0,j.jsxs)(ec,{children:[(0,j.jsx)(ed,{children:A.injectionScreen_notconnected_h1}),(0,j.jsx)(ep,{children:A.injectionScreen_notconnected_p})]})},tv.NOTCONNECTED),F===tv.UNAVAILABLE&&(0,j.jsx)(o5,{initial:"initial",animate:"animate",exit:"exit",variants:tk,children:M?(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(ec,{style:{paddingBottom:18},children:[(0,j.jsx)(ed,{children:A.injectionScreen_install_h1}),(0,j.jsx)(ep,{children:A.injectionScreen_install_p})]}),!f.isInstalled&&M&&(0,j.jsx)(Button,{href:M,icon:(0,j.jsx)(tx,{}),children:A.installTheExtension})]}):(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(ec,{style:{paddingBottom:12},children:[(0,j.jsx)(ed,{children:A.injectionScreen_unavailable_h1}),(0,j.jsx)(ep,{children:A.injectionScreen_unavailable_p})]}),!f.isInstalled&&I&&(0,j.jsxs)(Button,{href:null==I?void 0:I.url,icon:(0,j.jsx)(tx,{browser:null==I?void 0:I.name}),children:["Install on ",null==I?void 0:I.label]})]})},tv.UNAVAILABLE)]})})]})}):(0,j.jsx)(er,{children:(0,j.jsxs)(o8,{children:[(0,j.jsx)(es,{children:"Invalid State"}),(0,j.jsx)(ec,{children:(0,j.jsx)(Alert,{children:"No connectors match the id given. This state should never happen."})})]})})},tw=Z(M.E.div)`
  z-index: 3;
  position: relative;
  overflow: hidden;
  height: 0;
...
`,tz=Z(M.E.div)`
  ...
  &:before {
    ...
    opacity: 0.75;
    background-size: 200% 100%;
    animation: ${tB} 1000ms linear infinite both;
  }
...
`,ChainSelectDropdown=({children:e,open:o,onClose:t,offsetX:n=0,offsetY:i=8})=>{var r,a,s;let l=useContext(),c=useThemeContext(),d=useLocales(),[p,h]=(0,L.useState)({x:0,y:0});useLockBodyScroll(o);let u=(0,L.useRef)(null);(0,L.useEffect)(()=>{let listener=e=>{var n,i,r;if(o&&("Escape"===e.key&&t(),"ArrowDown"===e.key||"ArrowUp"===e.key)){if(!u.current)return;e.preventDefault();let o=null===(n=u.current)||void 0===n?void 0:n.querySelectorAll(`
            ...
            input[type="checkbox"]:not(:disabled),
            select:not(:disabled)
          `),t=o[0],a=o[o.length-1];if("ArrowUp"===e.key){if(document.activeElement===t)a.focus();else{let e=null===(i=null==document?void 0:document.activeElement)||void 0===i?void 0:i.previousSibling;for(e||(e=a);e.disabled;)e=e.previousSibling;e.focus()}}else if(document.activeElement===a)t.focus();else{let e=null===(r=null==document?void 0:document.activeElement)||void 0===r?void 0:r.nextSibling;for(e||(e=t);e.disabled;)e=e.nextSibling;e.focus()}}};return document.addEventListener("keydown",listener),()=>{document.removeEventListener("keydown",listener)}},[o]);let x=(0,L.useRef)(null),b=(0,L.useCallback)(e=>{e&&(x.current=e,refresh())},[o]),[g,C]=(0,W.Z)({debounce:120,offsetSize:!0,scroll:!0}),refresh=()=>{if(!x.current||C.top+C.bottom+C.left+C.right+C.height+C.width===0)return;let e=C.left+n,o=C.top+C.height+i;x.current.style.left=`${e}px`,x.current.style.top=`${o}px`},m="undefined"!=typeof window?L.useLayoutEffect:L.useEffect;return m(refresh,[x.current,C,o]),(0,L.useEffect)(refresh,[o,x.current]),(0,L.useEffect)(()=>(refresh(),window.addEventListener("scroll",t),window.addEventListener("resize",t),()=>{window.removeEventListener("scroll",t),window.removeEventListener("resize",t)}),[]),(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)("div",{ref:g,children:e}),(0,j.jsx)(S.M,{children:o&&(0,j.jsx)(Portal,{children:(0,j.jsx)(J,{$useTheme:null!==(r=c.theme)&&void 0!==r?r:l.theme,$useMode:null!==(a=c.mode)&&void 0!==a?a:l.mode,$customTheme:null!==(s=c.customTheme)&&void 0!==s?s:l.customTheme,children:(0,j.jsx)(FocusTrap,{children:(0,j.jsxs)(tq,{ref:u,children:[(0,j.jsx)(tK,{onClick:t}),(0,j.jsxs)(t$,{ref:b,style:{left:p.x,top:p.y},initial:"collapsed",animate:"open",exit:"collapsed",variants:{collapsed:{transformOrigin:"0 0",opacity:0,scale:.96,z:.01,y:-4,x:0,transition:{duration:.1}},open:{transformOrigin:"0 0",willChange:"opacity,transform",opacity:1,scale:1,z:.01,y:0,x:0,transition:{ease:[.76,0,.24,1],duration:.15}}},children:[(0,j.jsx)(t1,{children:d.switchNetworks}),(0,j.jsx)(ChainSelectList,{})]})]})})})})})]})},t0=Z.div`
  --bg: transparent;
  --color: #333;
...
`,ThemedButton=({children:e,variant:o="primary",autoSize:t=!0,duration:n=.3,style:i})=>{let[r,a]=(0,W.Z)();return(0,j.jsx)(ng,{className:o,initial:!1,animate:t?{width:a.width>10?a.width:"auto"}:void 0,transition:{duration:n,ease:[.25,1,.5,1],delay:.01},style:i,children:(0,j.jsx)("div",{ref:r,style:{whiteSpace:"nowrap",width:"fit-content",position:"relative",padding:"0 12px"},children:e})})},nm=Z(M.E.div)`
  display: flex;
  align-items: center;
  justify-content: center;
  gap: 8px;
...
`,Balance=({hideIcon:e,hideSymbol:o})=>{let t=useIsMounted(),[n,i]=(0,L.useState)(!0),{address:r}=(0,l.mA)(),{chain:a}=(0,l.LN)(),{data:s}=(0,l.KQ)({address:r,chainId:null==a?void 0:a.id,watch:!0}),c=tZ.find(e=>e.id===(null==a?void 0:a.id)),d=`${t&&(null==s?void 0:s.formatted)!==void 0?`balance-${null==c?void 0:c.id}-${null==s?void 0:s.formatted}`:"balance-loading"}`;return(0,L.useEffect)(()=>{i(!1)},[]),(0,j.jsx)("div",{style:{position:"relative"},children:(0,j.jsx)(S.M,{initial:!1,children:(0,j.jsx)(M.E.div,{initial:(null==s?void 0:s.formatted)!==void 0&&n?{opacity:1}:{opacity:0,position:"absolute",top:0,left:0,bottom:0},animate:{opacity:1,position:"relative"},exit:{opacity:0,position:"absolute",top:0,left:0,bottom:0},transition:{duration:.4,ease:[.25,1,.5,1],delay:.4},children:r&&t&&(null==s?void 0:s.formatted)!==void 0?(null==a?void 0:a.unsupported)?(0,j.jsxs)(nm,{children:[!e&&(0,j.jsx)(Chain,{id:null==a?void 0:a.id}),(0,j.jsx)("span",{style:{minWidth:32},children:"???"})]}):(0,j.jsxs)(nm,{children:[!e&&(0,j.jsx)(Chain,{id:null==a?void 0:a.id}),(0,j.jsx)("span",{style:{minWidth:32},children:nFormatter(Number(null==s?void 0:s.formatted))}),!o&&` ${null==s?void 0:s.symbol}`]}):(0,j.jsxs)(nm,{children:[!e&&(0,j.jsx)(Chain,{}),(0,j.jsx)("span",{style:{minWidth:32},children:(0,j.jsxs)(nv,{children:[(0,j.jsx)("span",{style:{animationDelay:"0ms"}}),(0,j.jsx)("span",{style:{animationDelay:"50ms"}}),(0,j.jsx)("span",{style:{animationDelay:"100ms"}})]})})]})},d)})})},nk={initial:{zIndex:2,opacity:0,x:"-100%"},animate:{opacity:1,x:.1,transition:{duration:.4,ease:[.25,1,.5,1]}},exit:{zIndex:1,opacity:0,x:"-100%",pointerEvents:"none",position:"absolute",transition:{duration:.4,ease:[.25,1,.5,1]}}},nw={initial:{zIndex:2,opacity:0,x:"100%"},animate:{x:.2,opacity:1,transition:{duration:.4,ease:[.25,1,.5,1]}},exit:{zIndex:1,x:"100%",opacity:0,pointerEvents:"none",position:"absolute",transition:{duration:.4,ease:[.25,1,.5,1]}}},ny={initial:{opacity:0},animate:{opacity:1,transition:{duration:.3,ease:[.25,1,.5,1]}},exit:{position:"absolute",opacity:0,transition:{duration:.3,ease:[.25,1,.5,1]}}},ConnectButtonRenderer=({children:e})=>{let o=useIsMounted(),t=useContext(),{open:n,setOpen:i}=useModal(),{chain:r}=(0,l.LN)(),{address:a,isConnected:s}=(0,l.mA)(),{data:c}=(0,l.F6)({chainId:1,address:a});function hide(){i(!1)}function show(){i(!0),t.setRoute(s?nc.PROFILE:nc.CONNECTORS)}return e&&o?(0,j.jsx)(j.Fragment,{children:e({show,hide,chain:r,unsupported:!!(null==r?void 0:r.unsupported),isConnected:!!a,isConnecting:n,address:a,truncatedAddress:a?truncateEthAddress(a):void 0,ensName:null==c?void 0:c.toString()})}):null};function ConnectKitButtonInner({label:e,showAvatar:o,separator:t}){var n;let i=useLocales({}),r=useContext(),{isSignedIn:a}=useSIWE(),{address:s}=(0,l.mA)(),{data:c}=(0,l.F6)({chainId:1,address:s}),{chain:d}=(0,l.LN)(),p=i.connectWallet;return(0,j.jsx)(S.M,{initial:!1,children:s?(0,j.jsxs)(nu,{initial:"initial",animate:"animate",exit:"exit",variants:nw,style:{height:40},children:[o&&(0,j.jsxs)(nx,{children:[(0,j.jsxs)(S.M,{initial:!1,children:[a&&(0,j.jsx)(M.E.div,{style:{zIndex:2,position:"absolute",bottom:0,right:0},initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,j.jsx)(AuthIcon,{})}),(null==d?void 0:d.unsupported)&&(0,j.jsx)(nb,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,j.jsx)("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,j.jsx)("path",{d:"M1.68831 13.5H12.0764C13.1026 13.5 13.7647 12.7197 13.7647 11.763C13.7647 11.4781 13.6985 11.1863 13.5462 10.9149L8.34225 1.37526C8.02445 0.791754 7.45505 0.5 6.88566 0.5C6.31627 0.5 5.73364 0.791754 5.42246 1.37526L0.225108 10.9217C0.0728291 11.1863 0 11.4781 0 11.763C0 12.7197 0.662083 13.5 1.68831 13.5ZM6.88566 8.8048C6.49503 8.8048 6.27655 8.5809 6.26331 8.1738L6.16399 5.0595C6.15075 4.64562 6.44869 4.34708 6.87904 4.34708C7.30278 4.34708 7.61396 4.6524 7.60071 5.06628L7.5014 8.16701C7.48154 8.5809 7.26305 8.8048 6.88566 8.8048ZM6.88566 11.3492C6.44207 11.3492 6.07792 11.0303 6.07792 10.5757C6.07792 10.1211 6.44207 9.80219 6.88566 9.80219C7.32926 9.80219 7.69341 10.1143 7.69341 10.5757C7.69341 11.0371 7.32264 11.3492 6.88566 11.3492Z",fill:"currentColor"})})})]}),(0,j.jsx)(Avatar,{size:24,address:s})]}),(0,j.jsx)("div",{style:{position:"relative",paddingRight:o?1:0},children:(0,j.jsx)(S.M,{initial:!1,children:c?(0,j.jsx)(nu,{initial:"initial",animate:"animate",exit:"exit",variants:ny,style:{position:c?"relative":"absolute"},children:(null===(n=r.options)||void 0===n?void 0:n.truncateLongENSAddress)?truncateENSAddress(c,20):c},"ckEnsName"):(0,j.jsxs)(nu,{initial:"initial",animate:"animate",exit:"exit",variants:ny,style:{position:c?"absolute":"relative"},children:[truncateEthAddress(s,t)," "]},"ckTruncatedAddress")})})]},"connectedText"):(0,j.jsx)(nu,{initial:"initial",animate:"animate",exit:"exit",variants:nk,style:{height:40},children:e||p},"connectWalletText")})}function ConnectKitButton({label:e,showBalance:o=!1,showAvatar:t=!0,theme:n,mode:i,customTheme:r,onClick:a}){var s;let c=useIsMounted(),d=useContext(),{isConnected:p,address:h}=(0,l.mA)(),{chain:u}=(0,l.LN)();function show(){d.setOpen(!0),d.setRoute(p?nc.PROFILE:nc.CONNECTORS)}let x=["web95","rounded","minimal"].includes(null!==(s=null!=n?n:d.theme)&&void 0!==s?s:"")?"....":void 0;if(!c)return null;let b=o&&!(null==u?void 0:u.unsupported);return(0,j.jsx)(J,{$useTheme:null!=n?n:d.theme,$useMode:null!=i?i:d.mode,$customTheme:null!=r?r:d.customTheme,children:(0,j.jsxs)(nC,{onClick:()=>{a?a(show):show()},children:[b&&(0,j.jsx)(S.M,{initial:!1,children:h&&b&&(0,j.jsx)(M.E.div,{initial:{opacity:0,x:"100%",width:0,marginRight:0},animate:{opacity:1,x:0,width:"auto",marginRight:-24,transition:{duration:.4,ease:[.25,1,.5,1]}},exit:{opacity:0,x:"100%",width:0,marginRight:0,transition:{duration:.4,ease:[.25,1,.5,1]}},children:(0,j.jsx)(ThemedButton,{variant:"secondary",theme:null!=n?n:d.theme,mode:null!=i?i:d.mode,customTheme:null!=r?r:d.customTheme,style:{overflow:"hidden"},children:(0,j.jsx)(M.E.div,{style:{paddingRight:24},children:(0,j.jsx)(Balance,{hideSymbol:!0})})})},"balance")}),(0,j.jsx)(ThemedButton,{theme:null!=n?n:d.theme,mode:null!=i?i:d.mode,customTheme:null!=r?r:d.customTheme,style:b&&o&&h&&("retro"===n||"retro"===d.theme)?{boxShadow:"var(--ck-connectbutton-balance-connectbutton-box-shadow)",borderRadius:"var(--ck-connectbutton-balance-connectbutton-border-radius)",overflow:"hidden"}:{overflow:"hidden"},children:(0,j.jsx)(ConnectKitButtonInner,{separator:x,showAvatar:t,label:e})})]})})}ConnectButtonRenderer.displayName="ConnectKitButton.Custom",ConnectKitButton.Custom=ConnectButtonRenderer;let nj=F.F4`
  0%{ transform:none; }
...
`;Z.div`
  ...
  opacity: 0;
  &.play {
    animation: ${nL} 1300ms 200ms cubic-bezier(0.16, 1, 0.6, 1) both;
  }
`,Z.div`
  z-index: 1;
  position: absolute;
  inset: 0;
  &.shake {
    animation: ${nj} 300ms 100ms cubic-bezier(0.16, 1, 0.6, 1) both;
  }
`,Z.div`
  z-index: 1;
  position: absolute;
