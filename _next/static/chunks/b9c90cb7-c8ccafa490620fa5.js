...
`;function useWalletConnectUri({enabled:e}={enabled:!0}){let{log:o}=useContext(),[t,n]=(0,j.useState)(void 0),i=useWalletConnectConnector(),r=(null==i?void 0:i.id)==="walletConnectLegacy",{isConnected:a}=(0,l.mA)(),{connectAsync:s}=useConnect();return(0,j.useEffect)(()=>{if(e&&i&&!t&&i&&!a)return connectWalletConnect(i),o("add wc listeners"),i.on("message",handleMessage),i.on("change",handleChange),i.on("connect",handleConnect),i.on("disconnect",handleDisconnect),i.on("error",handleError),()=>{o("remove wc listeners"),i.off("message",handleMessage),i.off("change",handleChange),i.off("connect",handleConnect),i.off("disconnect",handleDisconnect),i.off("error",handleError)};async function handleMessage({type:e,data:t}){if(o("WC Message",e,t),r){if(o("isWalletConnectLegacy"),"connecting"===e){let e=await i.getProvider();n(e.connector.uri),e.connector.on("disconnect",()=>{o("User rejected, regenerate QR code"),connectWalletConnect(i)})}}else"display_uri"===e&&n(t)}async function handleChange(e){o("WC Change",e)}async function handleDisconnect(){var e;o("WC Disconnect"),i&&(null===(e=i.options)||void 0===e?void 0:e.version)==="1"&&connectWallet(i)}async function handleConnect(){o("WC Connect")}async function handleError(e){o("WC Error",e)}async function connectWallet(e){let o=await s({connector:e});return!!o&&o}async function connectWalletConnect(e){try{await connectWallet(e)}catch(t){o("catch error"),o(t),t.code?4001===t.code?(o("error.code - User rejected"),connectWalletConnect(e)):o("error.code - Unknown Error"):o("WalletConnect cannot connect.",t)}}},[e,i,a]),{uri:t}}let oU=R(E.E.div)`
  z-index: 2147483647;
  position: fixed;
  inset: 0;
  pointer-events: none;
...
`;function addressToNumber(e){return e.split("").map(e=>e.charCodeAt(0)).reduce((e,o)=>e+o)%100/100}let tF=R(E.E.div)`
  ...
  ${e=>{if(e.$seed){let o=Math.ceil(8*addressToNumber(e.$seed)),t=`0${0===o?1:o}`;return I.iv`
